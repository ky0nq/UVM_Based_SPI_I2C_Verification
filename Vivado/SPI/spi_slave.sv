...
module spi_slave #(
    ...
    assign sample_edge = (CPOL == CPHA) ? sclk_rising  : sclk_falling;
    assign shift_edge  = (CPOL == CPHA) ? sclk_falling : sclk_rising;
    // ==========================================================================
...
module spi_slave #(
    ...
    always_ff @(posedge clk or posedge rst) begin
        if (rst) sclk_prev <= CPOL;
        else      sclk_prev <= sclk;
    end

    logic sclk_rising, sclk_falling;
    assign sclk_rising  = ( sclk & ~sclk_prev);
    assign sclk_falling = (~sclk &  sclk_prev);
